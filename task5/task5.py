...
# get the vehicle with the greatest number of violations
sorted_list = total_plateid_state.sortBy(lambda x: x[1], False)
greatest = sc.parallelize(sorted_list.take(1))
